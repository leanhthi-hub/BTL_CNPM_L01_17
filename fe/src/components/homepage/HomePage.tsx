  ...
  return (
    <div className='flex flex-col'>
      <div className='flex'>
        ...
        <Image src={'/assets/home_image.png'}  alt='image' width={600} height={600} />
      </div>
      <div className='bg-[#F7F7F7] '>
        ...
        <div className='grid grid-cols-3 gap-2'>
            <div className='p-4 bg-white m-8 rounded-[1rem] shadow-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300'>
              <Image src={'/assets/icon_1.png'} alt='icon' width={60} height={60}/>
            ...
            <div className='p-4 bg-white m-8 rounded-[1rem] shadow-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300'>
              <Image src={'/assets/icon_2.png'} alt='icon' width={60} height={60}/>
            ...
            <div className='p-4 bg-white m-8 rounded-[1rem] shadow-lg transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300'>
              <Image src={'/assets/icon_3.png'} alt='icon' width={60} height={60}/>
